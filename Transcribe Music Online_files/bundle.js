      ...
      var m = (function(e2) {
        ...
        s(t, [{
          ...
          value: function() {
            ...
            }, h("How can I preserve my progress?", "Saving is disabled for now. A localStorage-based save flow will be added later."), h("I need something else.", t2));
          }
        }]);
        return t;
      })(c.default.Component);
    ...
    "src/app/components/Toolbar.js"(exports, module) {
      ...
      var c = (function(e2) {
        ...
        i(t, [{
          ...
          value: function(e3) {
            if (e3.key === " " || e3.key === "Spacebar" || e3.keyCode === 32) {
              e3.preventDefault();
              e3.stopPropagation();
  ...
  var require_entry = __commonJS({
    "src/app/entry.js"(exports, module) {
      ...
      exports.default = function(e2, t) {
        var n = d.default.renderToString(a.default.createElement(appProvider.default, e2));
