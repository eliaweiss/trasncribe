(() => {
  ...
  function Header({ onChooseAudio, onChooseYouTube }) {
    return /* @__PURE__ */ import_react.default.createElement("nav", { className: "navbar navbar-default", role: "navigation" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "navbar-header" }, /* @__PURE__ */ import_react.default.createElement("button", { type: "button", className: "navbar-toggle" }, /* @__PURE__ */ import_react.default.createElement("span", { className: "sr-only" }, "Toggle navigation"), /* @__PURE__ */ import_react.default.createElement("span", null, "Menu")), /* @__PURE__ */ import_react.default.createElement("a", { className: "navbar-brand", href: "#", onClick: (event) => event.preventDefault() }, /* @__PURE__ */ import_react.default.createElement("img", { src: "./Transcribe Music Online_files/logo-blueblock.png", alt: "Transcribe Music Online" }))), /* @__PURE__ */ import_react.default.createElement("div", { className: "collapse navbar-collapse navbar-ex1-collapse" }, /* @__PURE__ */ import_react.default.createElement("ul", { className: "nav navbar-nav navbar-right" }, /* @__PURE__ */ import_react.default.createElement("li", null, /* @__PURE__ */ import_react.default.createElement("a", { href: "#", onClick: (event) => {
      event.preventDefault();
      onChooseAudio();
    } }, "Choose Audio")), /* @__PURE__ */ import_react.default.createElement("li", null, /* @__PURE__ */ import_react.default.createElement("a", { href: "#", onClick: (event) => {
      event.preventDefault();
      onChooseYouTube();
    } }, "Choose YouTube")))));
  }
  ...
  function Landing({ onChooseAudio, onLoadYouTube }) {
    const [youtubeUrl, setYoutubeUrl] = (0, import_react2.useState)("");
    return /* @__PURE__ */ import_react2.default.createElement("div", { id: "landing" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "container" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "hero-cont" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "hero" }, /* @__PURE__ */ import_react2.default.createElement("h1", { className: "title" }, /* @__PURE__ */ import_react2.default.createElement("span", { className: "bb" }, "Transcribe"), " music", /* @__PURE__ */ import_react2.default.createElement("span", { style: { display: "block", paddingTop: 20 } }, "like a pro.")), /* @__PURE__ */ import_react2.default.createElement("h2", { className: "tagline", style: { marginBottom: "1.5em" } }, "Slow down your favorite songs so you can learn how they are played."), /* @__PURE__ */ import_react2.default.createElement("button", { className: "btn btn-primary btn-lg", onClick: onChooseAudio }, "Load an MP3"), /* @__PURE__ */ import_react2.default.createElement(
      "form",
      {
      ...
      " ",
      /* @__PURE__ */ import_react2.default.createElement("button", { className: "btn btn-primary btn-lg", type: "submit" }, "Load YouTube Video")
    )), /* @__PURE__ */ import_react2.default.createElement("div", { id: "screenshot", className: "main-img" }, /* @__PURE__ */ import_react2.default.createElement("img", { src: "./Transcribe Music Online_files/screenshot.png", alt: "Waveform screenshot" })))));
  }

  // src/components/Player.jsx
  var import_react10 = __toESM(require_react());

  // src/utils/audioBuffer.js
  ...
  function TimeTicks({ duration, width }) {
    ...
    return /* @__PURE__ */ import_react3.default.createElement("div", { className: "overlay bottom", id: "time-panel", style: { width } }, ticks.map((time) => /* @__PURE__ */ import_react3.default.createElement("div", { key: time, className: "time-tick", style: { left: `${time / duration * width}px` } }, /* @__PURE__ */ import_react3.default.createElement("label", null, formatTime(time)))));
  }
  ...
  var WaveformCanvas = (0, import_react4.forwardRef)(function WaveformCanvas2({ audioBuffer, height, width }, ref) {
    (0, import_react4.useEffect)(() => {
      if (ref.current) drawWaveform(ref.current, audioBuffer);
    }, [audioBuffer, ref, width]);
    return /* @__PURE__ */ import_react4.default.createElement("canvas", { ref, width, height, className: "overlay", id: "waveform-data", style: { top: 0, bottom: 18 } });
  });
  var WaveformCanvas_default = WaveformCanvas;
  ...
  function SelectionOverlay({ height, onSeek, selection, selectionMode, setSelection, width }) {
    ...
    const [dragStart, setDragStart] = (0, import_react5.useState)(null);
  ...
  function MarkerOverlay({ marks, width }) {
    return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, marks.filter((mark) => mark.type !== "loop").map((mark) => /* @__PURE__ */ import_react6.default.createElement("div", { key: mark.id, className: `overlay mark-panel ${mark.type === "beat" ? "bottom" : ""}`, style: { left: mark.position * width } }, /* @__PURE__ */ import_react6.default.createElement("label", null, mark.label))));
  }
  ...
  function Timeline({ audioBuffer, duration, marks, onSeek, onSetSelection, position, selection, selectionMode, width }) {
    ...
    return /* @__PURE__ */ import_react7.default.createElement("div", { className: "mouse-container", style: { height: HEIGHT } }, /* @__PURE__ */ import_react7.default.createElement("div", { className: "overlay", style: { height: HEIGHT, zIndex: 39, width }, onClick: handleSeek }), /* @__PURE__ */ import_react7.default.createElement(MarkerOverlay, { marks, width }), /* @__PURE__ */ import_react7.default.createElement(TimeTicks, { duration, width }), /* @__PURE__ */ import_react7.default.createElement(WaveformCanvas_default, { ref: canvasRef, audioBuffer, height: HEIGHT - 18, width }), /* @__PURE__ */ import_react7.default.createElement("div", { className: "overlay", id: "waveform-position", style: { width }, height: HEIGHT, onClick: handleSeek }, /* @__PURE__ */ import_react7.default.createElement("div", { className: "position-line", style: { left: `${position * width}px` } })), /* @__PURE__ */ import_react7.default.createElement(
      SelectionOverlay,
      {
        height: HEIGHT,
        onSeek,
  ...
  function Toolbar(props) {
    ...
    ), /* @__PURE__ */ import_react8.default.createElement("span", { className: "flashicon emboss", style: { marginRight: "-1em" } }, "Fast"), /* @__PURE__ */ import_react8.default.createElement("div", { style: { paddingTop: ".25em" } }, tempo, "%")));
  }
  ...
  // src/components/YouTubePlayer.jsx
  function YouTubePlayer({ onPlayerReady, videoId }) {
    const containerRef = (0, import_react9.useRef)(null);
    const onPlayerReadyRef = (0, import_react9.useRef)(onPlayerReady);
    ...
    return /* @__PURE__ */ import_react9.default.createElement("div", { style: { margin: "0 auto 1em", maxWidth: 426 } }, /* @__PURE__ */ import_react9.default.createElement("div", { ref: containerRef }));
  }
  ...
  function Player(props) {
    ...
    const width = (0, import_react10.useMemo)(() => Math.max(window.innerWidth * zoom, window.innerWidth), [zoom]);
    return /* @__PURE__ */ import_react10.default.createElement("div", { id: "player", className: "visible-audio-loaded", style: { marginLeft: 0 } }, /* @__PURE__ */ import_react10.default.createElement("div", { className: "inner-container" }, /* @__PURE__ */ import_react10.default.createElement("div", { className: "btn-group btn-group-sm pull-right" }, /* @__PURE__ */ import_react10.default.createElement("button", { type: "button", className: "btn btn-default", onClick: () => onZoom(Math.max(1, zoom - 1)) }, "-"), /* @__PURE__ */ import_react10.default.createElement("button", { type: "button", className: "btn btn-default" }, "Zoom"), /* @__PURE__ */ import_react10.default.createElement("button", { type: "button", className: "btn btn-default", onClick: () => onZoom(Math.min(20, zoom + 1)) }, "+")), /* @__PURE__ */ import_react10.default.createElement("h1", null, fileName || "Audio File")), /* @__PURE__ */ import_react10.default.createElement("div", { id: "display" }, sourceType === "youtube" && youtubeVideoId && /* @__PURE__ */ import_react10.default.createElement(YouTubePlayer, { onPlayerReady: onYouTubePlayerReady, videoId: youtubeVideoId }), /* @__PURE__ */ import_react10.default.createElement(
      Timeline,
      {
        audioBuffer,
        duration,
  ...
  function ControlPanel({ duration, marks, onAddBeat, onAddLoop, onAddMark, onRemoveMark }) {
    const visibleMarks = marks.filter((mark) => mark.type !== "loop");
    const loops = marks.filter((mark) => mark.type === "loop");
    return /* @__PURE__ */ import_react11.default.createElement("div", { className: "control-panel visible-audio-loaded", style: { marginLeft: 0 } }, /* @__PURE__ */ import_react11.default.createElement("div", { className: "btn-group" }, /* @__PURE__ */ import_react11.default.createElement("button", { className: "btn btn-default btn-sm", title: "You can also tap 'm' to add a mark", onClick: onAddMark }, "Add Mark"), /* @__PURE__ */ import_react11.default.createElement("button", { className: "btn btn-default btn-sm", title: "You can also tap 'b' to add a beat", onClick: onAddBeat }, "Add Beat"), /* @__PURE__ */ import_react11.default.createElement("button", { className: "btn btn-default btn-sm", title: "Save the current selection as a loop", onClick: onAddLoop }, "Add Loop")), !visibleMarks.length && !loops.length && /* @__PURE__ */ import_react11.default.createElement("p", { id: "empty-mark-message", style: { display: "block" } }, "Tap Add Mark or Add Beat while playing to label parts of the song."), /* @__PURE__ */ import_react11.default.createElement("ul", { className: "cards" }, visibleMarks.map((mark) => /* @__PURE__ */ import_react11.default.createElement("li", { key: mark.id, className: "card" }, /* @__PURE__ */ import_react11.default.createElement("strong", null, mark.type === "beat" ? "Beat" : "Mark"), " ", formatTime(mark.time), /* @__PURE__ */ import_react11.default.createElement("button", { className: "btn btn-default btn-xs", onClick: () => onRemoveMark(mark.id) }, "Remove")))), /* @__PURE__ */ import_react11.default.createElement("ul", { className: "cards" }, loops.map((loop) => /* @__PURE__ */ import_react11.default.createElement("li", { key: loop.id, className: "card" }, /* @__PURE__ */ import_react11.default.createElement("strong", null, "Loop"), " ", formatTime(loop.position * duration), " - ", formatTime(loop.end * duration), /* @__PURE__ */ import_react11.default.createElement("button", { className: "btn btn-default btn-xs", onClick: () => onRemoveMark(loop.id) }, "Remove")))));
  }
  ...
  function useAudioPlayer() {
    ...
    const [youtubeVideoId, setYoutubeVideoId] = (0, import_react12.useState)("");
    ...
    const setTempo = (0, import_react12.useCallback)((nextTempo) => {
    ...
    const loadYouTube = (0, import_react12.useCallback)((videoId) => {
      const audio = audioRef.current;
      if (sourceUrl) URL.revokeObjectURL(sourceUrl);
      audio.pause();
    ...
    const attachYouTubePlayer = (0, import_react12.useCallback)((player) => {
    ...
    const playFromStart = (0, import_react12.useCallback)(async () => {
      if (sourceType === "youtube") {
        const player = youtubePlayerRef.current;
        if (!player) return;
    ...
    const seek = (0, import_react12.useCallback)((seconds) => {
      if (sourceType === "youtube") {
        const player = youtubePlayerRef.current;
        if (!player || !Number.isFinite(seconds)) return;
        const max2 = player.getDuration?.() || seconds;
        const nextTime = Math.max(0, Math.min(seconds, max2));
    ...
    (0, import_react12.useEffect)(() => {
      if (sourceType !== "youtube") return void 0;
  ...
  function App() {
    ...
    const chooseAudio = (0, import_react13.useCallback)(() => {
      fileInputRef.current?.click();
    }, []);
    const loadFile = (0, import_react13.useCallback)(async (file) => {
      if (!file) return;
    ...
    const loadYouTube = (0, import_react13.useCallback)((url) => {
    ...
    const chooseYouTube = (0, import_react13.useCallback)(() => {
      const url = window.prompt("Paste a YouTube URL");
      if (url) loadYouTube(url);
    }, [loadYouTube]);
    const onFileInput = (0, import_react13.useCallback)((event) => {
      loadFile(event.target.files?.[0]);
      event.target.value = "";
    }, [loadFile]);
    const addMarker = (0, import_react13.useCallback)((type) => {
    ...
    const removeMarker = (0, import_react13.useCallback)((id) => {
      setMarks((existing) => existing.filter((mark) => mark.id !== id));
    }, []);
    const saveLoopSelection = (0, import_react13.useCallback)(() => {
    ...
    const jumpToRatio = (0, import_react13.useCallback)((ratio) => {
      if (!isLoaded || !player.duration) return;
      player.seek(player.duration * ratio);
    }, [isLoaded, player]);
    const jumpToSelectionStart = (0, import_react13.useCallback)(() => {
      if (selection.start == null) return;
      jumpToRatio(selection.start);
    }, [jumpToRatio, selection.start]);
    const jumpToSelectionEnd = (0, import_react13.useCallback)(() => {
      if (selection.end == null) return;
  ...
  // src/main.jsx
  (0, import_client.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ import_react14.default.createElement(App, null));
})();
